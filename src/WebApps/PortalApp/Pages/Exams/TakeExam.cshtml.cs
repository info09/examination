...
namespace PortalApp.Pages.Exams
{
    ...
    public class TakeExamModel : PageModel
    {
        ...
        public TakeExamModel(IExamService examService, IExamResultService examResultService)
        {
        ...
        public async Task<IActionResult> OnPostSkipExamAsync([FromBody] SkipExamRequest skipExamRequest)
        {
            var exam = await _examResultService.SkipExamAsync(skipExamRequest);
            if (exam.IsSuccessed) {
